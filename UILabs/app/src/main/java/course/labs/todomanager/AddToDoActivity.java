			...
			public void onClick(View v) {
                ...
                switch (mPriorityRadioGroup.getCheckedRadioButtonId()){
                    ...
                    case R.id.medPriority:
                        ...
                        break;
                    default: // R.id.lowPriority
                        priority = Priority.LOW;
                        break;
                }


				Status status = mStatusRadioGroup.getCheckedRadioButtonId() == R.id.statusDone
				...
				data.setClass(AddToDoActivity.this, ToDoManagerActivity.class);
